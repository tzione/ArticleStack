...
export declare class NgxGalleryComponent implements OnInit, DoCheck, AfterViewInit {
    ...
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<NgxGalleryComponent, "ngx-gallery", never, { 'options': "options", 'images': "images" }, { 'imagesReady': "imagesReady", 'change': "change", 'previewOpen': "previewOpen", 'previewClose': "previewClose", 'previewChange': "previewChange" }, never>;
}
