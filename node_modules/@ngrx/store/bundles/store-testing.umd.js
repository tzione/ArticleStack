...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('tslib'), require('@angular/core'), require('rxjs'), require('@ngrx/store'), require('@angular/core/testing'),require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@ngrx/store/testing', ['exports', 'tslib', '@angular/core', 'rxjs', '@ngrx/store', '@angular/core/testing','@angular/core'], factory) :
...
}(this, function (exports, tslib_1, core, rxjs, store, testing,ɵngcc0) { 'use strict';
...
MockState.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: MockState, factory: function MockState_Factory(t) { return new (t || MockState)(); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(MockState, [{
        type: Injectable
...
MockStore.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: MockStore, factory: function MockStore_Factory(t) { return new (t || MockStore)(ɵngcc0.ɵɵinject(MockState), ɵngcc0.ɵɵinject(store.ActionsSubject), ɵngcc0.ɵɵinject(store.ReducerManager), ɵngcc0.ɵɵinject(store.INITIAL_STATE), ɵngcc0.ɵɵinject(MOCK_SELECTORS)); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(MockStore, [{
        type: Injectable
    }], function () { return [{ type: MockState }, { type: store.ActionsSubject }, { type: store.ReducerManager }, { type: Object, decorators: [{
                type: Inject,
...
MockReducerManager.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: MockReducerManager, factory: function MockReducerManager_Factory(t) { return new (t || MockReducerManager)(); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(MockReducerManager, [{
        type: Injectable
    }], function () { return []; }, null);
