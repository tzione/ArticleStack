...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('tslib'), require('@angular/core'), require('rxjs'), require('rxjs/operators'),require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@ngrx/store', ['exports', 'tslib', '@angular/core', 'rxjs', 'rxjs/operators','@angular/core'], factory) :
...
}(this, function (exports, tslib_1, core, rxjs, operators,ɵngcc0) { 'use strict';
...
ScannedActionsSubject.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: ScannedActionsSubject, factory: function ScannedActionsSubject_Factory(t) { return ɵScannedActionsSubject_BaseFactory(t || ScannedActionsSubject); }, providedIn: null });
const ɵScannedActionsSubject_BaseFactory = ɵngcc0.ɵɵgetInheritedFactory(ScannedActionsSubject);
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(ScannedActionsSubject, [{
        type: Injectable
    }], null, { ngOnDestroy: [] });
