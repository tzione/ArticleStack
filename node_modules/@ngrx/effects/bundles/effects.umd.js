...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('tslib'), require('@ngrx/store'), require('rxjs'), require('rxjs/operators'), require('@angular/core'),require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@ngrx/effects', ['exports', 'tslib', '@ngrx/store', 'rxjs', 'rxjs/operators', '@angular/core','@angular/core'], factory) :
...
}(this, function (exports, tslib_1, store, rxjs, operators, core,ɵngcc0) { 'use strict';
...
Actions.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: Actions, factory: function Actions_Factory(t) { return new (t || Actions)(ɵngcc0.ɵɵinject(store.ScannedActionsSubject)); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(Actions, [{
        type: Injectable
    }], function () { return [{ type: rxjs.Observable, decorators: [{
                type: Inject,
...
EffectSources.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: EffectSources, factory: function EffectSources_Factory(t) { return new (t || EffectSources)(ɵngcc0.ɵɵinject(core.ErrorHandler), ɵngcc0.ɵɵinject(store.Store)); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(EffectSources, [{
        type: Injectable
    }], function () { return [{ type: core.ErrorHandler }, { type: store.Store }]; }, { addEffects: [], toActions: [] });
...
EffectsRunner.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: EffectsRunner, factory: function EffectsRunner_Factory(t) { return new (t || EffectsRunner)(ɵngcc0.ɵɵinject(EffectSources), ɵngcc0.ɵɵinject(store.Store)); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(EffectsRunner, [{
        type: Injectable
    }], function () { return [{ type: EffectSources }, { type: store.Store }]; }, { effectSources: [], store: [], effectsSubscription: [], start: [], ngOnDestroy: [] });
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(EffectsRootModule, [{
        type: NgModule,
        args: [{}]
    }], function () { return [{ type: EffectSources }, { type: EffectsRunner }, { type: store.Store }, { type: Array, decorators: [{
                type: Inject,
                args: [ROOT_EFFECTS]
            }] }, { type: store.StoreRootModule, decorators: [{
                type: Optional
            }] }, { type: store.StoreFeatureModule, decorators: [{
                type: Optional
...
EffectsRootModule.ngInjectorDef = ɵngcc0.ɵɵdefineInjector({ factory: function EffectsRootModule_Factory(t) { return new (t || EffectsRootModule)(ɵngcc0.ɵɵinject(EffectSources), ɵngcc0.ɵɵinject(EffectsRunner), ɵngcc0.ɵɵinject(store.Store), ɵngcc0.ɵɵinject(ROOT_EFFECTS), ɵngcc0.ɵɵinject(store.StoreRootModule, 8), ɵngcc0.ɵɵinject(store.StoreFeatureModule, 8), ɵngcc0.ɵɵinject(_ROOT_EFFECTS_GUARD, 8)); } });
...
EffectsFeatureModule.ngInjectorDef = ɵngcc0.ɵɵdefineInjector({ factory: function EffectsFeatureModule_Factory(t) { return new (t || EffectsFeatureModule)(ɵngcc0.ɵɵinject(EffectsRootModule), ɵngcc0.ɵɵinject(FEATURE_EFFECTS), ɵngcc0.ɵɵinject(store.StoreRootModule, 8), ɵngcc0.ɵɵinject(store.StoreFeatureModule, 8)); } });
