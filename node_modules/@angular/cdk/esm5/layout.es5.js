...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(MediaMatcher, [{
    ...
    }], function () { return [{ type: Platform }]; }, { _platform: [], _matchMedia: [], matchMedia: [] });
    return MediaMatcher;
}());
/**
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(BreakpointObserver, [{
        type: Injectable,
        args: [{ providedIn: 'root' }]
    }], function () { return [{ type: MediaMatcher }, { type: NgZone }]; }, { _mediaMatcher: [], _zone: [], _queries: [], _destroySubject: [], ngOnDestroy: [], isMatched: [], observe: [], _registerQuery: [] });
